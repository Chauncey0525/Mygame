...
# ====================================================================
#  六元素共通技能池  (每元素 17 个，unlock_level 对应白卡解锁等级)
# ====================================================================
...
ELEMENT_SKILL_POOL = {
    ...
    # -------------------- 火 --------------------
    'fire': [
        {'id': 'fire_01', 'name': '烈焰突刺',   'power': 90,  'type': 'physical', 'target': 'single',     'cooldown': 0, 'unlock_level': 1,
         'description': '以火焰覆盖武器突刺敌人', 'effects': []},
        {'id': 'fire_02', 'name': '灼烧打击',   'power': 110, 'type': 'physical', 'target': 'single',     'cooldown': 1, 'unlock_level': 5,
         'description': '灼热攻击，使目标陷入灼烧', 'effects': [{'type': 'burn', 'chance': 0.3, 'damage_pct': 5, 'duration': 2}]},
        {'id': 'fire_03', 'name': '火焰护盾',   'power': 25,  'type': 'buff',     'target': 'self',       'cooldown': 3, 'unlock_level': 10,
         'description': '用火焰凝聚护盾，提升防御', 'effects': [{'type': 'buff_def', 'value': 25, 'duration': 3}]},
        {'id': 'fire_04', 'name': '烈焰箭',     'power': 130, 'type': 'magic',    'target': 'single',     'cooldown': 1, 'unlock_level': 15,
         'description': '射出烈焰之箭，造成魔法伤害', 'effects': []},
        {'id': 'fire_05', 'name': '焰爆术',     'power': 160, 'type': 'magic',    'target': 'single',     'cooldown': 2, 'unlock_level': 20,
         'description': '凝聚火焰能量爆发', 'effects': [{'type': 'burn', 'chance': 0.4, 'damage_pct': 6, 'duration': 2}]},
        {'id': 'fire_06', 'name': '焰爆连击',   'power': 180, 'type': 'physical', 'target': 'single',     'cooldown': 2, 'unlock_level': 25,
         'description': '火焰附着的连续打击', 'effects': []},
        {'id': 'fire_07', 'name': '火龙卷',     'power': 150, 'type': 'magic',    'target': 'all',        'cooldown': 3, 'unlock_level': 30,
         'description': '召唤火焰龙卷席卷敌方全体', 'effects': []},
        {'id': 'fire_08', 'name': '烈焰之心',   'power': 30,  'type': 'buff',     'target': 'self',       'cooldown': 4, 'unlock_level': 35,
         'description': '点燃内心之火，大幅提升攻击力', 'effects': [{'type': 'buff_atk', 'value': 30, 'duration': 3}]},
        {'id': 'fire_09', 'name': '业火焚身',   'power': 250, 'type': 'magic',    'target': 'single',     'cooldown': 2, 'unlock_level': 40,
         'description': '业火缠身，造成大量魔法伤害并灼烧', 'effects': [{'type': 'burn', 'chance': 0.5, 'damage_pct': 8, 'duration': 2}]},
        {'id': 'fire_10', 'name': '火墙术',     'power': 200, 'type': 'magic',    'target': 'all',        'cooldown': 3, 'unlock_level': 45,
         'description': '烈火之墙横扫战场，降低敌方防御', 'effects': [{'type': 'debuff_def', 'value': 15, 'duration': 2}]},
        {'id': 'fire_11', 'name': '凤凰冲击',   'power': 300, 'type': 'physical', 'target': 'single',     'cooldown': 3, 'unlock_level': 50,
         'description': '化身凤凰猛冲，造成毁灭性物理伤害', 'effects': []},
        {'id': 'fire_12', 'name': '灼热领域',   'power': 250, 'type': 'magic',    'target': 'all',        'cooldown': 4, 'unlock_level': 55,
         'description': '展开灼热力场，灼烧全体敌人并降低攻击', 'effects': [{'type': 'debuff_atk', 'value': 15, 'duration': 2}]},
        {'id': 'fire_13', 'name': '火神之怒',   'power': 380, 'type': 'magic',    'target': 'single',     'cooldown': 3, 'unlock_level': 60,
         'description': '引动火神之力倾注于一点', 'effects': []},
        {'id': 'fire_14', 'name': '不灭之焰',   'power': 35,  'type': 'heal',     'target': 'ally_single','cooldown': 4, 'unlock_level': 65,
         'description': '不灭圣火治愈友方并赋予火焰护盾', 'effects': [{'type': 'shield', 'value': 15, 'duration': 2}]},
        {'id': 'fire_15', 'name': '烈焰风暴',   'power': 350, 'type': 'magic',    'target': 'all',        'cooldown': 4, 'unlock_level': 70,
         'description': '引爆烈焰风暴席卷全场', 'effects': [{'type': 'burn', 'chance': 0.6, 'damage_pct': 8, 'duration': 3}]},
        {'id': 'fire_16', 'name': '焚天灭地',   'power': 450, 'type': 'physical', 'target': 'single',     'cooldown': 4, 'unlock_level': 75,
         'description': '焚天之力集于一击，无视部分防御', 'effects': [{'type': 'ignore_def', 'value': 30}]},
        {'id': 'fire_17', 'name': '涅槃之焰',   'power': 400, 'type': 'magic',    'target': 'all',        'cooldown': 5, 'unlock_level': 80,
         'description': '涅槃烈焰焚烧一切，自身回复生命', 'effects': [{'type': 'lifesteal', 'value': 20}]},
    ],

    # -------------------- 水 --------------------
    'water': [
        {'id': 'water_01', 'name': '水流斩',     'power': 85,  'type': 'physical', 'target': 'single',     'cooldown': 0, 'unlock_level': 1,
         'description': '以高压水流强化的武器劈砍', 'effects': []},
        {'id': 'water_02', 'name': '寒冰打击',   'power': 105, 'type': 'physical', 'target': 'single',     'cooldown': 1, 'unlock_level': 5,
         'description': '寒冰附体的攻击，有概率减速', 'effects': [{'type': 'slow', 'chance': 0.3, 'value': 15, 'duration': 2}]},
        {'id': 'water_03', 'name': '水盾术',     'power': 20,  'type': 'buff',     'target': 'self',       'cooldown': 3, 'unlock_level': 10,
         'description': '凝聚水盾提升防御，并微量回复', 'effects': [{'type': 'buff_def', 'value': 20, 'duration': 3}, {'type': 'heal_pct', 'value': 8}]},
        {'id': 'water_04', 'name': '冰刺术',     'power': 130, 'type': 'magic',    'target': 'single',     'cooldown': 1, 'unlock_level': 15,
         'description': '从地面升起尖锐冰刺贯穿目标', 'effects': []},
        {'id': 'water_05', 'name': '潮汐之力',   'power': 160, 'type': 'magic',    'target': 'single',     'cooldown': 2, 'unlock_level': 20,
         'description': '引动潮汐之力冲击目标', 'effects': []},
        {'id': 'water_06', 'name': '冰封打击',   'power': 175, 'type': 'physical', 'target': 'single',     'cooldown': 2, 'unlock_level': 25,
         'description': '冰封之拳命中目标，有概率冻结', 'effects': [{'type': 'freeze', 'chance': 0.25, 'duration': 1}]},
        {'id': 'water_07', 'name': '暴风雪',     'power': 145, 'type': 'magic',    'target': 'all',        'cooldown': 3, 'unlock_level': 30,
         'description': '降下暴风雪覆盖全场', 'effects': [{'type': 'slow', 'chance': 0.4, 'value': 10, 'duration': 2}]},
        {'id': 'water_08', 'name': '治愈之泉',   'power': 25,  'type': 'heal',     'target': 'ally_single','cooldown': 3, 'unlock_level': 35,
         'description': '召唤清泉治愈一名友方', 'effects': []},
        {'id': 'water_09', 'name': '冰霜囚笼',   'power': 240, 'type': 'magic',    'target': 'single',     'cooldown': 2, 'unlock_level': 40,
         'description': '冰霜牢笼囚禁目标并造成大量伤害', 'effects': [{'type': 'freeze', 'chance': 0.35, 'duration': 1}]},
        {'id': 'water_10', 'name': '潮汐涌动',   'power': 200, 'type': 'magic',    'target': 'all',        'cooldown': 3, 'unlock_level': 45,
         'description': '潮汐涌动冲刷全体敌人', 'effects': [{'type': 'slow', 'chance': 0.5, 'value': 15, 'duration': 2}]},
        {'id': 'water_11', 'name': '水龙弹',     'power': 290, 'type': 'magic',    'target': 'single',     'cooldown': 3, 'unlock_level': 50,
         'description': '化水为龙轰击目标', 'effects': []},
        {'id': 'water_12', 'name': '冰封领域',   'power': 240, 'type': 'magic',    'target': 'all',        'cooldown': 4, 'unlock_level': 55,
         'description': '展开绝对冰域，冻结全场', 'effects': [{'type': 'freeze', 'chance': 0.4, 'duration': 1}]},
        {'id': 'water_13', 'name': '深海之怒',   'power': 370, 'type': 'magic',    'target': 'single',     'cooldown': 3, 'unlock_level': 60,
         'description': '引动深海之力碾碎目标', 'effects': []},
        {'id': 'water_14', 'name': '治愈之雨',   'power': 30,  'type': 'heal',     'target': 'ally_all',   'cooldown': 4, 'unlock_level': 65,
         'description': '降下治愈甘霖，治愈全体友方', 'effects': []},
        {'id': 'water_15', 'name': '海啸冲击',   'power': 340, 'type': 'magic',    'target': 'all',        'cooldown': 4, 'unlock_level': 70,
         'description': '掀起滔天巨浪淹没全场', 'effects': []},
        {'id': 'water_16', 'name': '绝对零度',   'power': 440, 'type': 'magic',    'target': 'single',     'cooldown': 4, 'unlock_level': 75,
         'description': '将目标冷冻至绝对零度', 'effects': [{'type': 'freeze', 'chance': 0.6, 'duration': 2}]},
        {'id': 'water_17', 'name': '沧海横流',   'power': 400, 'type': 'magic',    'target': 'all',        'cooldown': 5, 'unlock_level': 80,
         'description': '沧海之力倾泻而出，吞噬一切', 'effects': [{'type': 'freeze', 'chance': 0.5, 'duration': 1}]},
    ],

    # -------------------- 风 --------------------
    'wind': [
        {'id': 'wind_01', 'name': '风刃',       'power': 80,  'type': 'physical', 'target': 'single',     'cooldown': 0, 'unlock_level': 1,
         'description': '以风之力强化的利刃斩击', 'effects': []},
        {'id': 'wind_02', 'name': '疾风步',     'power': 20,  'type': 'buff',     'target': 'self',       'cooldown': 2, 'unlock_level': 5,
         'description': '提升自身速度，先发制人', 'effects': [{'type': 'buff_spd', 'value': 20, 'duration': 3}]},
        {'id': 'wind_03', 'name': '旋风斩',     'power': 100, 'type': 'physical', 'target': 'all',        'cooldown': 2, 'unlock_level': 10,
         'description': '旋转武器形成风刃切割全体', 'effects': []},
        {'id': 'wind_04', 'name': '穿透之风',   'power': 135, 'type': 'physical', 'target': 'single',     'cooldown': 1, 'unlock_level': 15,
         'description': '风之刃穿透护甲，无视部分防御', 'effects': [{'type': 'ignore_def', 'value': 15}]},
        {'id': 'wind_05', 'name': '真空刃',     'power': 170, 'type': 'physical', 'target': 'single',     'cooldown': 2, 'unlock_level': 20,
         'description': '压缩空气形成真空斩击', 'effects': []},
        {'id': 'wind_06', 'name': '风暴之眼',   'power': 25,  'type': 'buff',     'target': 'self',       'cooldown': 3, 'unlock_level': 25,
         'description': '立于风暴中心，提升闪避与暴击', 'effects': [{'type': 'buff_crit', 'value': 25, 'duration': 3}, {'type': 'evasion_up', 'value': 20, 'duration': 3}]},
        {'id': 'wind_07', 'name': '龙卷风',     'power': 155, 'type': 'magic',    'target': 'all',        'cooldown': 3, 'unlock_level': 30,
         'description': '召唤龙卷风席卷全场', 'effects': []},
        {'id': 'wind_08', 'name': '迅捷之风',   'power': 20,  'type': 'buff',     'target': 'ally_all',   'cooldown': 4, 'unlock_level': 35,
         'description': '吹拂迅捷之风，全队速度提升', 'effects': [{'type': 'buff_spd', 'value': 20, 'duration': 3}]},
        {'id': 'wind_09', 'name': '裂空斩',     'power': 260, 'type': 'physical', 'target': 'single',     'cooldown': 2, 'unlock_level': 40,
         'description': '斩裂天空的强力一击', 'effects': []},
        {'id': 'wind_10', 'name': '风之结界',   'power': 25,  'type': 'buff',     'target': 'ally_all',   'cooldown': 4, 'unlock_level': 45,
         'description': '风之结界庇护全队，提升闪避', 'effects': [{'type': 'evasion_up', 'value': 25, 'duration': 3}]},
        {'id': 'wind_11', 'name': '暴风连斩',   'power': 280, 'type': 'physical', 'target': 'single',     'cooldown': 3, 'unlock_level': 50,
         'description': '风速下的连续利刃斩击', 'effects': [{'type': 'buff_crit', 'value': 15, 'duration': 1}]},
        {'id': 'wind_12', 'name': '风神之怒',   'power': 250, 'type': 'magic',    'target': 'all',        'cooldown': 4, 'unlock_level': 55,
         'description': '风神震怒，狂风横扫全场', 'effects': []},
        {'id': 'wind_13', 'name': '天翔百裂',   'power': 360, 'type': 'physical', 'target': 'single',     'cooldown': 3, 'unlock_level': 60,
         'description': '翔于天际的百连斩击', 'effects': []},
        {'id': 'wind_14', 'name': '瞬步',       'power': 30,  'type': 'buff',     'target': 'self',       'cooldown': 4, 'unlock_level': 65,
         'description': '极速瞬移，必定回避下次攻击并反击', 'effects': [{'type': 'evasion_up', 'value': 100, 'duration': 1}, {'type': 'counter', 'value': 50}]},
        {'id': 'wind_15', 'name': '风暴领域',   'power': 330, 'type': 'magic',    'target': 'all',        'cooldown': 4, 'unlock_level': 70,
         'description': '展开风暴领域吞噬全场', 'effects': [{'type': 'debuff_spd', 'value': 20, 'duration': 2}]},
        {'id': 'wind_16', 'name': '神风',       'power': 430, 'type': 'physical', 'target': 'single',     'cooldown': 4, 'unlock_level': 75,
         'description': '化身神风，一击贯穿', 'effects': [{'type': 'ignore_def', 'value': 30}]},
        {'id': 'wind_17', 'name': '天风归一',   'power': 400, 'type': 'magic',    'target': 'all',        'cooldown': 5, 'unlock_level': 80,
         'description': '天地之风归于一体，毁灭一切', 'effects': []},
    ],

    # -------------------- 土 --------------------
    'earth': [
        {'id': 'earth_01', 'name': '岩石打击',   'power': 95,  'type': 'physical', 'target': 'single',     'cooldown': 0, 'unlock_level': 1,
         'description': '以岩石硬化的拳头打击敌人', 'effects': []},
        {'id': 'earth_02', 'name': '大地之盾',   'power': 25,  'type': 'buff',     'target': 'self',       'cooldown': 3, 'unlock_level': 5,
         'description': '召唤大地之力形成护盾', 'effects': [{'type': 'buff_def', 'value': 25, 'duration': 3}]},
        {'id': 'earth_03', 'name': '地刺术',     'power': 115, 'type': 'physical', 'target': 'single',     'cooldown': 1, 'unlock_level': 10,
         'description': '从地面升起尖刺贯穿目标', 'effects': []},
        {'id': 'earth_04', 'name': '岩铠',       'power': 30,  'type': 'buff',     'target': 'self',       'cooldown': 4, 'unlock_level': 15,
         'description': '披上岩石铠甲，大幅提升双防', 'effects': [{'type': 'buff_def', 'value': 30, 'duration': 3}, {'type': 'buff_mdef', 'value': 30, 'duration': 3}]},
        {'id': 'earth_05', 'name': '地裂波',     'power': 150, 'type': 'magic',    'target': 'all',        'cooldown': 3, 'unlock_level': 20,
         'description': '震裂大地，波及全体敌人', 'effects': []},
        {'id': 'earth_06', 'name': '石化打击',   'power': 180, 'type': 'physical', 'target': 'single',     'cooldown': 2, 'unlock_level': 25,
         'description': '石化之拳命中目标，有概率眩晕', 'effects': [{'type': 'stun', 'chance': 0.2, 'duration': 1}]},
        {'id': 'earth_07', 'name': '巨岩崩落',   'power': 200, 'type': 'physical', 'target': 'single',     'cooldown': 2, 'unlock_level': 30,
         'description': '召唤巨岩从天而降砸向目标', 'effects': []},
        {'id': 'earth_08', 'name': '大地恩赐',   'power': 25,  'type': 'heal',     'target': 'self',       'cooldown': 4, 'unlock_level': 35,
         'description': '大地的馈赠，回复自身生命并提升防御', 'effects': [{'type': 'buff_def', 'value': 15, 'duration': 2}]},
        {'id': 'earth_09', 'name': '山崩地裂',   'power': 230, 'type': 'magic',    'target': 'all',        'cooldown': 3, 'unlock_level': 40,
         'description': '山崩地裂，地面碎裂冲击全体', 'effects': []},
        {'id': 'earth_10', 'name': '钢铁之壁',   'power': 30,  'type': 'buff',     'target': 'ally_all',   'cooldown': 4, 'unlock_level': 45,
         'description': '为全队构筑钢铁之壁，提升防御', 'effects': [{'type': 'buff_def', 'value': 30, 'duration': 3}]},
        {'id': 'earth_11', 'name': '地龙翻身',   'power': 280, 'type': 'magic',    'target': 'all',        'cooldown': 3, 'unlock_level': 50,
         'description': '地龙翻身引发大范围地震', 'effects': [{'type': 'stun', 'chance': 0.2, 'duration': 1}]},
        {'id': 'earth_12', 'name': '磐石之心',   'power': 35,  'type': 'buff',     'target': 'self',       'cooldown': 5, 'unlock_level': 55,
         'description': '磐石般的意志，大幅减伤', 'effects': [{'type': 'shield', 'value': 35, 'duration': 3}]},
        {'id': 'earth_13', 'name': '天崩地裂',   'power': 350, 'type': 'magic',    'target': 'all',        'cooldown': 4, 'unlock_level': 60,
         'description': '天崩地裂之力撕碎战场', 'effects': []},
        {'id': 'earth_14', 'name': '泰山压顶',   'power': 400, 'type': 'physical', 'target': 'single',     'cooldown': 3, 'unlock_level': 65,
         'description': '以泰山之重压碎目标', 'effects': [{'type': 'stun', 'chance': 0.4, 'duration': 1}]},
        {'id': 'earth_15', 'name': '山岳镇压',   'power': 320, 'type': 'physical', 'target': 'all',        'cooldown': 4, 'unlock_level': 70,
         'description': '以山岳之力镇压全体敌人', 'effects': [{'type': 'stun', 'chance': 0.3, 'duration': 1}]},
        {'id': 'earth_16', 'name': '不动如山',   'power': 40,  'type': 'buff',     'target': 'self',       'cooldown': 5, 'unlock_level': 75,
         'description': '不动如山，反弹部分伤害并免疫控制', 'effects': [{'type': 'shield', 'value': 40, 'duration': 3}, {'type': 'counter', 'value': 30}]},
        {'id': 'earth_17', 'name': '开天辟地',   'power': 420, 'type': 'magic',    'target': 'all',        'cooldown': 5, 'unlock_level': 80,
         'description': '开天辟地之力重塑战场', 'effects': [{'type': 'stun', 'chance': 0.4, 'duration': 1}]},
    ],

    # -------------------- 光 --------------------
    'light': [
        {'id': 'light_01', 'name': '圣光斩',     'power': 85,  'type': 'magic',    'target': 'single',     'cooldown': 0, 'unlock_level': 1,
         'description': '圣光加持的斩击', 'effects': []},
        {'id': 'light_02', 'name': '圣光术',     'power': 15,  'type': 'heal',     'target': 'ally_single','cooldown': 2, 'unlock_level': 5,
         'description': '基础圣光治愈术', 'effects': []},
        {'id': 'light_03', 'name': '审判之光',   'power': 120, 'type': 'magic',    'target': 'single',     'cooldown': 1, 'unlock_level': 10,
         'description': '光之审判降于敌人', 'effects': []},
        {'id': 'light_04', 'name': '圣盾术',     'power': 20,  'type': 'buff',     'target': 'ally_single','cooldown': 3, 'unlock_level': 15,
         'description': '为友方赋予圣光护盾', 'effects': [{'type': 'buff_def', 'value': 20, 'duration': 3}]},
        {'id': 'light_05', 'name': '光明祝福',   'power': 15,  'type': 'buff',     'target': 'ally_all',   'cooldown': 3, 'unlock_level': 20,
         'description': '光之祝福笼罩全队，提升全属性', 'effects': [{'type': 'buff_atk', 'value': 10, 'duration': 3}, {'type': 'buff_def', 'value': 10, 'duration': 3}]},
        {'id': 'light_06', 'name': '神圣一击',   'power': 185, 'type': 'magic',    'target': 'single',     'cooldown': 2, 'unlock_level': 25,
         'description': '集中圣光的强力一击', 'effects': []},
        {'id': 'light_07', 'name': '光明审判',   'power': 160, 'type': 'magic',    'target': 'all',        'cooldown': 3, 'unlock_level': 30,
         'description': '圣光从天而降审判敌方全体', 'effects': []},
        {'id': 'light_08', 'name': '净化之光',   'power': 25,  'type': 'heal',     'target': 'ally_single','cooldown': 3, 'unlock_level': 35,
         'description': '净化之光治愈友方并清除异常状态', 'effects': [{'type': 'cleanse'}]},
        {'id': 'light_09', 'name': '天使之翼',   'power': 20,  'type': 'heal',     'target': 'ally_all',   'cooldown': 4, 'unlock_level': 40,
         'description': '天使双翼展开，全队回复并获得护盾', 'effects': [{'type': 'shield', 'value': 10, 'duration': 2}]},
        {'id': 'light_10', 'name': '圣光洗礼',   'power': 25,  'type': 'heal',     'target': 'ally_all',   'cooldown': 4, 'unlock_level': 45,
         'description': '圣光洗礼全队，恢复大量生命', 'effects': []},
        {'id': 'light_11', 'name': '神圣惩戒',   'power': 300, 'type': 'magic',    'target': 'single',     'cooldown': 3, 'unlock_level': 50,
         'description': '天罚降下，惩戒邪恶', 'effects': []},
        {'id': 'light_12', 'name': '圣域展开',   'power': 25,  'type': 'buff',     'target': 'ally_all',   'cooldown': 4, 'unlock_level': 55,
         'description': '展开圣域，全队减伤', 'effects': [{'type': 'shield', 'value': 25, 'duration': 3}]},
        {'id': 'light_13', 'name': '天堂制裁',   'power': 360, 'type': 'magic',    'target': 'all',        'cooldown': 4, 'unlock_level': 60,
         'description': '天堂之力制裁全体敌人', 'effects': []},
        {'id': 'light_14', 'name': '复活之光',   'power': 50,  'type': 'heal',     'target': 'ally_single','cooldown': 5, 'unlock_level': 65,
         'description': '强大的圣光使濒死者重获新生', 'effects': [{'type': 'revive_pct', 'value': 30}]},
        {'id': 'light_15', 'name': '圣光风暴',   'power': 340, 'type': 'magic',    'target': 'all',        'cooldown': 4, 'unlock_level': 70,
         'description': '圣光风暴横扫全场', 'effects': []},
        {'id': 'light_16', 'name': '天使降临',   'power': 40,  'type': 'heal',     'target': 'ally_all',   'cooldown': 5, 'unlock_level': 75,
         'description': '天使降临，全队大幅治愈并强化', 'effects': [{'type': 'buff_atk', 'value': 15, 'duration': 3}, {'type': 'buff_def', 'value': 15, 'duration': 3}]},
        {'id': 'light_17', 'name': '创世之光',   'power': 420, 'type': 'magic',    'target': 'all',        'cooldown': 5, 'unlock_level': 80,
         'description': '创世之光照耀大地，焚灭一切暗影', 'effects': []},
    ],

    # -------------------- 暗 --------------------
    'dark': [
        {'id': 'dark_01', 'name': '暗影斩',     'power': 90,  'type': 'physical', 'target': 'single',     'cooldown': 0, 'unlock_level': 1,
         'description': '暗影附着的武器斩击', 'effects': []},
        {'id': 'dark_02', 'name': '生命汲取',   'power': 100, 'type': 'magic',    'target': 'single',     'cooldown': 1, 'unlock_level': 5,
         'description': '汲取目标生命力为自身回复', 'effects': [{'type': 'lifesteal', 'value': 30}]},
        {'id': 'dark_03', 'name': '暗影刺',     'power': 120, 'type': 'physical', 'target': 'single',     'cooldown': 1, 'unlock_level': 10,
         'description': '暗影之刺刺入要害，附带剧毒', 'effects': [{'type': 'poison', 'chance': 0.3, 'damage_pct': 4, 'duration': 3}]},
        {'id': 'dark_04', 'name': '恐惧术',     'power': 15,  'type': 'debuff',   'target': 'single',     'cooldown': 3, 'unlock_level': 15,
         'description': '释放恐惧降低目标攻击力', 'effects': [{'type': 'debuff_atk', 'value': 20, 'duration': 2}]},
        {'id': 'dark_05', 'name': '暗影爆发',   'power': 160, 'type': 'magic',    'target': 'all',        'cooldown': 3, 'unlock_level': 20,
         'description': '暗影能量爆发冲击全体', 'effects': []},
        {'id': 'dark_06', 'name': '诅咒之术',   'power': 20,  'type': 'debuff',   'target': 'all',        'cooldown': 4, 'unlock_level': 25,
         'description': '诅咒全体敌人，降低双防', 'effects': [{'type': 'debuff_def', 'value': 15, 'duration': 2}, {'type': 'debuff_mdef', 'value': 15, 'duration': 2}]},
        {'id': 'dark_07', 'name': '暗黑之刃',   'power': 200, 'type': 'physical', 'target': 'single',     'cooldown': 2, 'unlock_level': 30,
         'description': '暗黑之刃斩断一切', 'effects': []},
        {'id': 'dark_08', 'name': '灵魂汲取',   'power': 180, 'type': 'magic',    'target': 'all',        'cooldown': 3, 'unlock_level': 35,
         'description': '汲取全体敌人灵魂为自身回复', 'effects': [{'type': 'lifesteal', 'value': 25}]},
        {'id': 'dark_09', 'name': '暗影领域',   'power': 240, 'type': 'magic',    'target': 'all',        'cooldown': 3, 'unlock_level': 40,
         'description': '展开暗影领域侵蚀全体', 'effects': [{'type': 'debuff_atk', 'value': 10, 'duration': 2}]},
        {'id': 'dark_10', 'name': '死亡凝视',   'power': 260, 'type': 'magic',    'target': 'single',     'cooldown': 2, 'unlock_level': 45,
         'description': '死亡凝视目标，削弱其防御', 'effects': [{'type': 'debuff_def', 'value': 20, 'duration': 2}]},
        {'id': 'dark_11', 'name': '暗影风暴',   'power': 270, 'type': 'magic',    'target': 'all',        'cooldown': 3, 'unlock_level': 50,
         'description': '暗影风暴席卷全场', 'effects': []},
        {'id': 'dark_12', 'name': '腐蚀之雾',   'power': 230, 'type': 'magic',    'target': 'all',        'cooldown': 4, 'unlock_level': 55,
         'description': '弥漫腐蚀之雾毒害全体', 'effects': [{'type': 'poison', 'chance': 0.6, 'damage_pct': 6, 'duration': 3}]},
        {'id': 'dark_13', 'name': '冥界之门',   'power': 370, 'type': 'magic',    'target': 'all',        'cooldown': 4, 'unlock_level': 60,
         'description': '开启冥界之门释放亡灵之力', 'effects': []},
        {'id': 'dark_14', 'name': '灵魂收割',   'power': 400, 'type': 'physical', 'target': 'single',     'cooldown': 3, 'unlock_level': 65,
         'description': '收割灵魂，对低血量目标伤害倍增', 'effects': [{'type': 'execute', 'threshold': 30, 'bonus_mult': 1.5}]},
        {'id': 'dark_15', 'name': '黑暗吞噬',   'power': 350, 'type': 'magic',    'target': 'all',        'cooldown': 4, 'unlock_level': 70,
         'description': '黑暗吞噬一切光明，汲取全体生命', 'effects': [{'type': 'lifesteal', 'value': 20}]},
        {'id': 'dark_16', 'name': '末日审判',   'power': 450, 'type': 'magic',    'target': 'single',     'cooldown': 4, 'unlock_level': 75,
         'description': '末日降临，毁灭性的暗影集中于一点', 'effects': []},
        {'id': 'dark_17', 'name': '深渊降临',   'power': 420, 'type': 'magic',    'target': 'all',        'cooldown': 5, 'unlock_level': 80,
         'description': '深渊之力降临人间，吞噬一切', 'effects': [{'type': 'debuff_def', 'value': 25, 'duration': 3}]},
    ],
}
