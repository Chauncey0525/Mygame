...
_SEED_ELEMENT_SKILLS = {
    ...
    'water': [
        ...
        {'id': 'water_07', 'name': '暴风雪',     'power': 145, 'type': 'magic',    'target': 'all',        'cooldown': 3, 'unlock_level': 30, 'roles': None, 'description': '降下暴风雪覆盖全场', 'effects': [{'type': 'slow', 'chance': 0.4, 'value': 10, 'duration': 2}]},
        {'id': 'water_09', 'name': '冰霜囚笼',   'power': 240, 'type': 'magic',    'target': 'single',     'cooldown': 2, 'unlock_level': 40, 'roles': None, 'description': '冰霜牢笼囚禁目标', 'effects': [{'type': 'freeze', 'chance': 0.35, 'duration': 1}]},
        ...
        {'id': 'water_12', 'name': '冰封领域',   'power': 240, 'type': 'magic',    'target': 'all',        'cooldown': 4, 'unlock_level': 55, 'roles': None, 'description': '展开绝对冰域冻结全场', 'effects': [{'type': 'freeze', 'chance': 0.4, 'duration': 1}]},
        ...
        {'id': 'water_16', 'name': '绝对零度',   'power': 440, 'type': 'magic',    'target': 'single',     'cooldown': 4, 'unlock_level': 75, 'roles': None, 'description': '将目标冷冻至绝对零度', 'effects': [{'type': 'freeze', 'chance': 0.6, 'duration': 2}]},
        {'id': 'water_17', 'name': '沧海横流',   'power': 400, 'type': 'magic',    'target': 'all',        'cooldown': 5, 'unlock_level': 80, 'roles': None, 'description': '沧海之力倾泻而出', 'effects': [{'type': 'freeze', 'chance': 0.5, 'duration': 1}]},
        {'id': 'water_02a', 'name': '寒冰打击',  'power': 105, 'type': 'physical', 'target': 'single',     'cooldown': 1, 'unlock_level': 5,  'roles': [_W, _A, _T], 'description': '寒冰附体的近战攻击', 'effects': [{'type': 'slow', 'chance': 0.3, 'value': 15, 'duration': 2}]},
        {'id': 'water_02b', 'name': '冰霜射线',  'power': 110, 'type': 'magic',    'target': 'single',     'cooldown': 1, 'unlock_level': 5,  'roles': [_M, _S], 'description': '发射冰霜射线远程冻结目标', 'effects': [{'type': 'freeze', 'chance': 0.2, 'duration': 1}]},
        {'id': 'water_04a', 'name': '寒冰护甲',  'power': 25,  'type': 'buff',     'target': 'self',       'cooldown': 3, 'unlock_level': 15, 'roles': [_W, _T], 'description': '冰晶覆体，大幅提升双防', 'effects': [{'type': 'buff_def', 'value': 25, 'duration': 3}, {'type': 'buff_mdef', 'value': 20, 'duration': 3}]},
        {'id': 'water_04b', 'name': '冰刺术',    'power': 130, 'type': 'magic',    'target': 'single',     'cooldown': 1, 'unlock_level': 15, 'roles': [_M, _A, _S], 'description': '从地面升起冰刺贯穿目标', 'effects': []},
        {'id': 'water_06a', 'name': '冰封打击',  'power': 175, 'type': 'physical', 'target': 'single',     'cooldown': 2, 'unlock_level': 25, 'roles': [_W, _A], 'description': '冰封之拳有概率冻结目标', 'effects': [{'type': 'freeze', 'chance': 0.25, 'duration': 1}]},
        {'id': 'water_06b', 'name': '冰晶爆破',  'power': 170, 'type': 'magic',    'target': 'all',        'cooldown': 3, 'unlock_level': 25, 'roles': [_M], 'description': '引爆冰晶碎片横扫全场', 'effects': [{'type': 'slow', 'chance': 0.4, 'value': 15, 'duration': 2}]},
        ...
        {'id': 'water_08a', 'name': '寒冰武装',  'power': 25,  'type': 'buff',     'target': 'self',       'cooldown': 4, 'unlock_level': 35, 'roles': [_W, _A], 'description': '冰晶强化武器提升攻击与暴击', 'effects': [{'type': 'buff_atk', 'value': 25, 'duration': 3}, {'type': 'buff_crit', 'value': 20, 'duration': 3}]},
        ...
        {'id': 'water_10a', 'name': '潮汐涌动',  'power': 200, 'type': 'magic',    'target': 'all',        'cooldown': 3, 'unlock_level': 45, 'roles': [_M, _W], 'description': '潮汐涌动冲刷全体敌人', 'effects': [{'type': 'slow', 'chance': 0.5, 'value': 15, 'duration': 2}]},
        {'id': 'water_10b', 'name': '冰甲术',    'power': 30,  'type': 'buff',     'target': 'ally_all',   'cooldown': 4, 'unlock_level': 45, 'roles': [_T, _S], 'description': '全队覆盖冰甲大幅减伤', 'effects': [{'type': 'buff_def', 'value': 30, 'duration': 3}]},
        {'id': 'water_10c', 'name': '冰影连刺',  'power': 240, 'type': 'physical', 'target': 'single',     'cooldown': 2, 'unlock_level': 45, 'roles': [_A], 'description': '冰影闪烁中的连续穿刺', 'effects': [{'type': 'freeze', 'chance': 0.3, 'duration': 1}]},
    ],
    'wind': [
        {'id': 'wind_01', 'name': '风刃',       'power': 80,  'type': 'physical', 'target': 'single',     'cooldown': 0, 'unlock_level': 1,  'roles': None, 'description': '以风之力强化的利刃斩击', 'effects': []},
        {'id': 'wind_03', 'name': '旋风斩',     'power': 100, 'type': 'physical', 'target': 'all',        'cooldown': 2, 'unlock_level': 10, 'roles': None, 'description': '旋转武器形成风刃切割全体', 'effects': []},
        {'id': 'wind_05', 'name': '真空刃',     'power': 170, 'type': 'physical', 'target': 'single',     'cooldown': 2, 'unlock_level': 20, 'roles': None, 'description': '压缩空气形成真空斩击', 'effects': []},
        {'id': 'wind_07', 'name': '龙卷风',     'power': 155, 'type': 'magic',    'target': 'all',        'cooldown': 3, 'unlock_level': 30, 'roles': None, 'description': '召唤龙卷风席卷全场', 'effects': []},
        {'id': 'wind_09', 'name': '裂空斩',     'power': 260, 'type': 'physical', 'target': 'single',     'cooldown': 2, 'unlock_level': 40, 'roles': None, 'description': '斩裂天空的强力一击', 'effects': []},
        {'id': 'wind_11', 'name': '暴风连斩',   'power': 280, 'type': 'physical', 'target': 'single',     'cooldown': 3, 'unlock_level': 50, 'roles': None, 'description': '风速下的连续利刃斩击', 'effects': [{'type': 'buff_crit', 'value': 15, 'duration': 1}]},
        {'id': 'wind_12', 'name': '风神之怒',   'power': 250, 'type': 'magic',    'target': 'all',        'cooldown': 4, 'unlock_level': 55, 'roles': None, 'description': '风神震怒狂风横扫全场', 'effects': []},
        {'id': 'wind_13', 'name': '天翔百裂',   'power': 360, 'type': 'physical', 'target': 'single',     'cooldown': 3, 'unlock_level': 60, 'roles': None, 'description': '翔于天际的百连斩击', 'effects': []},
        {'id': 'wind_14', 'name': '瞬步',       'power': 30,  'type': 'buff',     'target': 'self',       'cooldown': 4, 'unlock_level': 65, 'roles': None, 'description': '极速瞬移回避并反击', 'effects': [{'type': 'evasion_up', 'value': 100, 'duration': 1}, {'type': 'counter', 'value': 50}]},
        {'id': 'wind_15', 'name': '风暴领域',   'power': 330, 'type': 'magic',    'target': 'all',        'cooldown': 4, 'unlock_level': 70, 'roles': None, 'description': '展开风暴领域吞噬全场', 'effects': [{'type': 'debuff_spd', 'value': 20, 'duration': 2}]},
        {'id': 'wind_16', 'name': '神风',       'power': 430, 'type': 'physical', 'target': 'single',     'cooldown': 4, 'unlock_level': 75, 'roles': None, 'description': '化身神风一击贯穿', 'effects': [{'type': 'ignore_def', 'value': 30}]},
        {'id': 'wind_17', 'name': '天风归一',   'power': 400, 'type': 'magic',    'target': 'all',        'cooldown': 5, 'unlock_level': 80, 'roles': None, 'description': '天地之风归于一体毁灭一切', 'effects': []},
        {'id': 'wind_02a', 'name': '疾风步',    'power': 20,  'type': 'buff',     'target': 'self',       'cooldown': 2, 'unlock_level': 5,  'roles': [_A, _W, _M], 'description': '提升自身速度先发制人', 'effects': [{'type': 'buff_spd', 'value': 20, 'duration': 3}]},
        {'id': 'wind_02b', 'name': '风盾术',    'power': 20,  'type': 'buff',     'target': 'self',       'cooldown': 3, 'unlock_level': 5,  'roles': [_T, _S], 'description': '风之护盾提升防御与闪避', 'effects': [{'type': 'buff_def', 'value': 15, 'duration': 3}, {'type': 'evasion_up', 'value': 15, 'duration': 3}]},
        {'id': 'wind_04a', 'name': '穿透之风',  'power': 135, 'type': 'physical', 'target': 'single',     'cooldown': 1, 'unlock_level': 15, 'roles': [_W, _A], 'description': '风之刃穿透护甲', 'effects': [{'type': 'ignore_def', 'value': 15}]},
        {'id': 'wind_04b', 'name': '风之治愈',  'power': 20,  'type': 'heal',     'target': 'ally_single','cooldown': 3, 'unlock_level': 15, 'roles': [_S], 'description': '以清风治愈友方伤痛', 'effects': []},
        {'id': 'wind_04c', 'name': '风暴之矛',  'power': 140, 'type': 'magic',    'target': 'single',     'cooldown': 1, 'unlock_level': 15, 'roles': [_M, _T], 'description': '凝聚风暴化为魔法矛刺', 'effects': []},
        {'id': 'wind_06a', 'name': '风暴之眼',  'power': 25,  'type': 'buff',     'target': 'self',       'cooldown': 3, 'unlock_level': 25, 'roles': [_A, _W], 'description': '立于风暴中心提升闪避与暴击', 'effects': [{'type': 'buff_crit', 'value': 25, 'duration': 3}, {'type': 'evasion_up', 'value': 20, 'duration': 3}]},
        {'id': 'wind_06b', 'name': '疾风守护',  'power': 20,  'type': 'buff',     'target': 'ally_all',   'cooldown': 4, 'unlock_level': 25, 'roles': [_T, _S], 'description': '全队获得风之守护提升防御', 'effects': [{'type': 'buff_def', 'value': 20, 'duration': 3}]},
        {'id': 'wind_06c', 'name': '风刃连斩',  'power': 180, 'type': 'magic',    'target': 'all',        'cooldown': 3, 'unlock_level': 25, 'roles': [_M], 'description': '无数风刃切割全体', 'effects': []},
        {'id': 'wind_08a', 'name': '迅捷之风',  'power': 20,  'type': 'buff',     'target': 'ally_all',   'cooldown': 4, 'unlock_level': 35, 'roles': [_S, _M], 'description': '全队速度提升', 'effects': [{'type': 'buff_spd', 'value': 20, 'duration': 3}]},
        {'id': 'wind_08b', 'name': '烈风斩',    'power': 220, 'type': 'physical', 'target': 'single',     'cooldown': 2, 'unlock_level': 35, 'roles': [_W, _A, _T], 'description': '以烈风强化的重斩', 'effects': []},
        {'id': 'wind_10a', 'name': '风之结界',  'power': 25,  'type': 'buff',     'target': 'ally_all',   'cooldown': 4, 'unlock_level': 45, 'roles': [_T, _S], 'description': '风之结界庇护全队提升闪避', 'effects': [{'type': 'evasion_up', 'value': 25, 'duration': 3}]},
        {'id': 'wind_10b', 'name': '真空斩击',  'power': 260, 'type': 'physical', 'target': 'single',     'cooldown': 2, 'unlock_level': 45, 'roles': [_W, _A], 'description': '真空压缩的极致一刀', 'effects': [{'type': 'ignore_def', 'value': 15}]},
        {'id': 'wind_10c', 'name': '飓风术',    'power': 250, 'type': 'magic',    'target': 'all',        'cooldown': 3, 'unlock_level': 45, 'roles': [_M], 'description': '召唤飓风席卷全场', 'effects': [{'type': 'debuff_spd', 'value': 15, 'duration': 2}]},
    ],
    'earth': [
...
def seed_skill_templates(db_session):
    """将种子数据写入 skill_templates 表（仅在表为空时执行）"""
    from models import SkillTemplate

    if db_session.query(SkillTemplate).first() is not None:
        return 0
